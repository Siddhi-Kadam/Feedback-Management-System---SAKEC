...
<meta charset="UTF-8">
    ...
    dataSource: {
        "chart": {
            "theme": "fusion",
            "caption": "Faculty Feedback Analysis(Practical) of:<?php echo $row1['full_name']; ?>(<?php echo $row11['lab_name'];?>)",
        ...
        "dataset": [
        {
            ...
            <?php
                for($i=1;$i<5;$i++){
                    $qu1="select avg(Q$i)*25 as c$i,Q$i from pfeedback where teacher_id='$stc' AND division='$di' AND batch='$ba'";
            ...
            <?php
                ...
                $qu1="select avg(Q5)*25 as c5,Q5 from pfeedback where teacher_id='$stc' AND division='$di' AND batch='$ba'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c5']!=NULL){
            ?>            
