    ...
    if(isset($_POST['submit'])){
        for ($j = 0; $j <15; $j++) {
            if(isset($_POST['R' . $j])){
                $b = $_POST['R' . $j];
                $a = $j+1; 
                $query=mysqli_query($feeddbc,"update cequestions set question='$b' where subject_no='$subjno' AND question_no='$a'");}}
    if ($query) {
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <?php
                                            $adminid=$_SESSION['feedid'];
                                            $ret=mysqli_query($feeddbc,"select * from cequestions where subject_no='$subjno'");
                                            ...
                                            <?php 
                                            $ret1=mysqli_query($feeddbc,"select * from cequestions where subject_no='$subjno'");
