...
<meta charset="UTF-8">
    ...
    dataSource: {
        ...
        "dataset": [
        {
            ...
            <?php
                for($i=1;$i<10;$i++){
                    $asd="select count(*) as cal from tfeedback where teacher_id='$stc' AND division='$di'";
                    $asd1=mysqli_query($feeddbc, $asd);
                    $ad = mysqli_fetch_array($asd1);
                    $qu1="select count(Q$i)*100 as c1$i,Q$i from tfeedback where teacher_id='$stc' AND division='$di' group by Q$i having Q$i='4'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r21 = mysqli_fetch_array($re1);
                    $qu2="select count(Q$i)*75 as c2$i,Q$i from tfeedback where teacher_id='$stc' AND division='$di' group by Q$i having Q$i='3'";
                    $re2=mysqli_query($feeddbc, $qu2);
                    $r22 = mysqli_fetch_array($re2);
                    $qu3="select count(Q$i)*50 as c3$i,Q$i from tfeedback where teacher_id='$stc' AND division='$di' group by Q$i having Q$i='2'";
                    $re3=mysqli_query($feeddbc, $qu3);
                    $r23 = mysqli_fetch_array($re3);
                    $qu4="select count(Q$i)*25 as c4$i,Q$i from tfeedback where teacher_id='$stc' AND division='$di' group by Q$i having Q$i='1'";
            ...
            <?php
                    ...
                    $qu1="select count(Q10)*100 as c110,Q10 from tfeedback where teacher_id='$stc' AND division='$di' group by Q10 having Q10='4'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r21 = mysqli_fetch_array($re1);
                    $qu2="select count(Q10)*75 as c210,Q10 from tfeedback where teacher_id='$stc' AND division='$di' group by Q10 having Q10='3'";
                    $re2=mysqli_query($feeddbc, $qu2);
                    $r22 = mysqli_fetch_array($re2);
                    $qu3="select count(Q10)*50 as c310,Q10 from tfeedback where teacher_id='$stc' AND division='$di' group by Q10 having Q10='2'";
                    $re3=mysqli_query($feeddbc, $qu3);
                    $r23 = mysqli_fetch_array($re3);
                    $qu4="select count(Q10)*25 as c410,Q10 from tfeedback where teacher_id='$stc' AND division='$di' group by Q10 having Q10='1'";
                    $re4=mysqli_query($feeddbc, $qu4);
                    $r24 = mysqli_fetch_array($re4);
