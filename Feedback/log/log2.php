<?php
    ...
    $sql = "select * from subject_table where div_id in (select div_id from intake where sem_id in (select sem_id from division_details,feedback where division_details.std_id=feedback.std_id)) limit 1 offset 1";
...
<form name="n">
    <br><center>
    <button type="submit" class="btn" name="Submit" formaction="log3.php">Next</button></center>
</form>
</body>
</html>