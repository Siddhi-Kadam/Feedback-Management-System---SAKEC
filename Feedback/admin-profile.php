...
if (strlen($_SESSION['feedid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $smobno=$_POST['smobilenumber'];
    $pmobno=$_POST['pmobilenumber'];
    $email=$_POST['email'];
    $query=mysqli_query($con,"update student_table2 set student_name='$UName', s_phone ='$smobno', email= '$email', p_phone='$pmobno' where std_id='$adminid'");
    if ($query) {
...
?>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="username" name="username" value="<?php  echo $row['student_name'];?>" class="form-control" required="">  
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="smobilenumber" name="smobilenumber" class="form-control" maxlength="10" value="<?php  echo $row['s_phone'];?>" required="">
                                                </div>
                                            </div>
                                          <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="pmobilenumber" name="pmobilenumber" class="form-control" maxlength="10" value="<?php  echo $row['p_phone'];?>" required="">
