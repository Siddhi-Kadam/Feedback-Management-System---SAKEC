...
else
{
    if(isset($_POST['Submit'])){
        ...
        $TCount=$rowtest["total_theory"];
        $se=$rowtest["semester"];
        if($TCount>4){
            header("Location: FF5.php");
        }
        elseif($TCount<5 && $se<5){
            header("Location: PFF.php");
        }
        elseif($TCount<5 && $se>4){
            ...
            <div class="main-content">
                ...
                <center>
                    ...
                    <?php 
                        ...
                        $programtest=$row123["program"];
                        //Selects subjects table 
                        $sql = "select * from subject_table where division='$divid' and semester='$semid' And program='$programtest' limit 1 offset 3";
