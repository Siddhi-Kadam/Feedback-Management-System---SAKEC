                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">                                      
                                <?php
                                    ...
                                    $di=$row["division"];
                                    $roll =$row["std_roll_no"];
                                    $programtest=$row["program"];
                                    $semes= $row["semester"];
                                    $sql = "select * from iloc_subject where std_roll_no ='$roll' and program='$programtest' AND semester = '$semes' AND division = '$di' limit 1";
                                ...
                                <?php
                                    ...
                                    while($row = mysqli_fetch_array($result)) { 
                                        $s1=$row["subject_no"];
                                        $sn=$row["subject_name"];
                                        $r=mysqli_query($feeddbc,"INSERT INTO tfeedback(std_id,teacher_id,subject_no) VALUES('$feedid','$s1')");
                                ?>
                                        <tr>
                                        ...
                                        <th>
                                            <?php
                                                $sql1="select * from subject_table where subject_table.subject_name='$sn'";
                                                $result1 = mysqli_query($con1,$sql1);
                                                $row1 = mysqli_fetch_array($result1);
                                                $t11=$row1["teacher1_id"];
                                                $t12=$row1["teacher2_id"];
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type='radio' name='Q<?php echo "$j"; ?>' value='3' checked>3  
