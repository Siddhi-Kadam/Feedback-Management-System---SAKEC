...
else
{
    if(isset($_POST['Submit'])){
        ...
        $semcount=$rowtest["semester"];
        $theorycount=$rowtest["total_theory"];
        if($theorycount >=3){
            header("Location: FF3.php");
        }
        else{
            ...
            <div class="main-content">
                ...
                <center>
                    ...
                    <?php 
                        ...
                        $sql = "select * from subject_table where division='$divid' and semester='$semid' and program = '$programtest' limit 1 offset 1";
