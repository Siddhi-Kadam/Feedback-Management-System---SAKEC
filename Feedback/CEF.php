...
if (strlen($_SESSION['feedid']==0)) 
{
  header('location:logout.php');
    ...
    if(isset($_POST['Submit'])){
        header("Location: Subject Selection.php");
    }
     ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card-body card-block">
                        <form method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group" style="margin-left:200px">                                      
                                ...
                                $sql = "select * from subject_table where division = '$division' AND subject_no='$subcode' limit 1";
                                ...
                                ?>
                                    ...
                                    <?php }
                                        ...
                                        <?php
                                        $sql2 = "select * from cequestions where subject_no='$subcode'";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type='radio' name='Q<?php echo "$j"; ?>' value='3' checked required>3
                                    ...
                                    <?php
                                    if(isset($_POST['Submit'])){
                                        $r=mysqli_query($feeddbc,"INSERT INTO cefeedback(std_id,subject_no,division) VALUES('$feedid','$subcode','$di')");
                                        for ($j = 1; $j <11; $j++) {
                                            if(isset($_POST['Q' . $j])){
                                                $a = $_POST['Q' . $j];   
                                                $r=mysqli_query($feeddbc,"UPDATE cefeedback set Q$j='$a' where subject_no='$subcode' AND std_id='$feedid' AND division='$di'");
                                            }
                                        }
                                    }?>
                            </div>
