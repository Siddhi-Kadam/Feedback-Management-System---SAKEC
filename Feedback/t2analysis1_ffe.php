...
<meta charset="UTF-8">
    ...
    dataSource: {
        ...
        "dataset": [
        {
            ...
            <?php
                for($i=1;$i<12;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from facilityfeedback where division='$di' group by Q$i having Q$i='4'";
            ...
            <?php
                ...
                $qu1="select count(Q10) as c12,Q10 from facilityfeedback where division='$di' group by Q10 having Q10='4'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c12']!=NULL){
            ?>            
...

        {
            ...
            <?php
                for($i=1;$i<12;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from facilityfeedback where division='$di' group by Q$i having Q$i='3'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r2 = mysqli_fetch_array($re1);
                    if($r2['c' . $i]!=NULL){
            ?>
            ...
            <?php
                ...
                $qu1="select count(Q10) as c12,Q10 from facilityfeedback where division='$di' group by Q10 having Q10='3'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c12']!=NULL){
            ?>            
        ...
        
        {
            ...
            <?php
                for($i=1;$i<12;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from facilityfeedback where division='$di' group by Q$i having Q$i='2'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r2 = mysqli_fetch_array($re1);
                    if($r2['c' . $i]!=NULL){
            ?>
            ...
            <?php
                ...
                $qu1="select count(Q10) as c12,Q10 from facilityfeedback where division='$di' group by Q10 having Q10='2'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c12']!=NULL){
            ?>            
        ...
        
        {
            ...
            <?php
                for($i=1;$i<12;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from facilityfeedback where division='$di' group by Q$i having Q$i='1'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r2 = mysqli_fetch_array($re1);
                    if($r2['c' . $i]!=NULL){
            ?>
            ...
            <?php
                ...
                $qu1="select count(Q10) as c12,Q10 from facilityfeedback where division='$di' group by Q10 having Q10='1'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c12']!=NULL){
            ?>            
