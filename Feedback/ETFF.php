                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Questions for Theory Faculty Feedback</strong>
                                    </div>
                                    <div class="card-body card-block">
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="card-footer">
                                                    ...
                                                    <td><p style="text-align: center;"><button class="btn btn-primary btn-sm"><a href="/Feedback/uploads/Book.csv" download="demo">Download Template</a></button></td>
                                                    ...
                                                    if(isset($_POST['submit'])){
                                                        mysqli_query($feeddbc,"Truncate tfquestions");
                                                        ...
                                                        if($_FILES["file"]["size"] > 0) {
                                                            ...
                                                            while (($col = fgetcsv($file, 10000, ",")) !== FALSE){
                                                                ...
                                                                $insert = "insert into tfquestions(question_no,question) values('" . $col[0] . "','" . $col[1] . "')";
