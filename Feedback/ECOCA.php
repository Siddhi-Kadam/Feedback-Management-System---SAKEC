                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Questions for Co-Curricular Activity Form</strong>
                                        </div>
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($_POST['submit'])){
                                                        mysqli_query($feeddbc,"Truncate coaquestions");
                                                        ...
                                                        if($_FILES["file"]["size"] > 0) {
                                                            ...
                                                            while (($col = fgetcsv($file, 10000, ",")) !== FALSE){
                                                                ...
                                                                $insert = "insert into coaquestions(question_no,question) values('" . $col[0] . "','" . $col[1] . "')";
