<?php
//Co-Curricular Activity Form For Student
session_start();
error_reporting(0);
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Choice For Co-Curricular Activity</strong>
                                    </div>
                                                            ...
                                                            <tr>
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="col-12 col-md-9">
                                                                        <input type="number" id="nococa" name="nococa" min="0" max= "10"  class="form-control" required="">
                                                                    </div>
                                                                </div>
                                                            </tr>
