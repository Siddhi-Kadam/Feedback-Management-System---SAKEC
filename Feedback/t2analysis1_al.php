...
<meta charset="UTF-8">
    ...
    dataSource: {
        "chart": {
            ...
            "xAxisname": "Questions",
            "yAxisName": "Number of Aluminis Scored",
            "numberPrefix": "",
            "showValues":"1",
            "plotFillAlpha": "80",
            "divLineIsDashed": "1",
        ...
        "dataset": [
        {
         ...
         indexLabelOrientation: "horizontal",
            ...
            <?php
                for($i=1;$i<10;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from alfeedback where Q$i='4'";
            ...
            <?php
                ...
                $qu1="select count(Q10) as c10,Q10 from alfeedback where Q10='4'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c10']!=NULL){
            ?>            
...

        {
            ...
            <?php
                for($i=1;$i<10;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from alfeedback where Q$i='3'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r2 = mysqli_fetch_array($re1);
                    if($r2['c' . $i]!=NULL){
            ?>
            ...
            <?php
                ...
                $qu1="select count(Q10) as c10,Q10 from alfeedback where Q10='3'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c10']!=NULL){
            ?>            
        ...
        
        {
            ...
            <?php
                for($i=1;$i<10;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from alfeedback where Q$i='2'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r2 = mysqli_fetch_array($re1);
                    if($r2['c' . $i]!=NULL){
            ?>
            ...
            <?php
                ...
                $qu1="select count(Q10) as c10,Q10 from alfeedback where Q10='2'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c10']!=NULL){
            ?>            
        ...
        
        {
            ...
            <?php
                for($i=1;$i<10;$i++){
                    $qu1="select count(Q$i) as c$i,Q$i from alfeedback where Q$i='1'";
                    $re1=mysqli_query($feeddbc, $qu1);
                    $r2 = mysqli_fetch_array($re1);
                    if($r2['c' . $i]!=NULL){
            ?>
            ...
            <?php
                ...
                $qu1="select count(Q10) as c10,Q10 from alfeedback where Q10='1'";
                $re1=mysqli_query($feeddbc, $qu1);
                $r2 = mysqli_fetch_array($re1);
                if($r2['c10']!=NULL){
            ?>            
