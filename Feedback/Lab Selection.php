...
if (strlen($_SESSION['feedid']==0)) {
  header('location:logout.php');
    ...
    if(isset($_POST['submit'])){
        $ch=$_POST['choice'];
        header("Location: LEF.php?code=$ch");}  
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <?php //Fetch batch and semester program division
                                                ...
                                                $sql = "select * from lab_table where division = '$divid' AND semester = '$semid' and program='$programtest' AND batch = '$batch'";
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        ...
                                                        <?php for($i=0;$i<5,$row= mysqli_fetch_array($result);$i++){
                                                            $l1=$row["lab_name"];
                                                            $ln=$row["lab_no"];?>
                                                            <option value="<?php echo "$ln"; ?>"><?php echo $l1;?></option>
                                                        <?php }?>
                                                        </select> 
                                                    </div>
                                                </div>
