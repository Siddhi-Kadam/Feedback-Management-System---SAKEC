...
if (strlen($_SESSION['feedid']==0)) 
{
  header('location:logout.php');
    ...
    if(isset($_POST['Submit'])){
        header("Location: Lab Selection.php");
    }
 ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="main-content">
                ...
                <center>
                    <div class="card-body card-block">
                        ...
                        $sql = "select * from lab_table where batch = '$batch' AND lab_no='$labcode' and semester='$semid' and program='$programtest' limit 1";
                            ...
                            <div class="row form-group">                                      
                                ...
                                ?>
                                    ...
                                    <?php }
                                        ...
                                        $sql2 = "select * from lequestions where lab_no='$labcode'";
                                    ...
                                    <?php
                                    if(isset($_POST['Submit'])){
                                        $r=mysqli_query($feeddbc,"INSERT INTO lefeedback(std_id,subject_no) VALUES('$feedid','$labcode')");
                                        for ($j = 1; $j <11; $j++) {
                                            if(isset($_POST['Q' . $j])){
                                                $a = $_POST['Q' . $j];   
                                                $r=mysqli_query($feeddbc,"UPDATE lefeedback set Q$j='$a' where subject_no='$labcode' AND std_id='$feedid'");
                                            }
                                        }
                                    }?>
                            </div>
