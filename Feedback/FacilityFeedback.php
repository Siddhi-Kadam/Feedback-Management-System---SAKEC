<?php
//Facility Feedback Form For Student
session_start();
error_reporting(0);
...
<head>
    ...
    <!-- Title Page-->
    <title>Facility Feedback Form</title>
                    ...
                    <div class="card-body card-block">
                        <form method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group" style="margin-left:200px">
                                ...
                                <tr>
                                        <th rowspan="2"><center>Facility Feedback</center></th>
                                    </tr>
                                    <tr><th>Ratings</th></tr>
                                <?php
                                ...
                                ?> 
                                    ...
                                    <?php
                                    if(isset($_POST['Submit'])){
                                        $r=mysqli_query($feeddbc,"INSERT INTO facilityfeedback(std_id,division) VALUES('$feedid','$di')");
                                        for ($j = 1; $j <13; $j++) {
                                            if(isset($_POST['Q' . $j])){
                                                $a = $_POST['Q' . $j];   
                                                $r=mysqli_query($feeddbc,"UPDATE facilityfeedback set Q$j='$a' where std_id='$feedid' and division='$di'");
                                            }
                                        }
                                    }?>
                            </div>
